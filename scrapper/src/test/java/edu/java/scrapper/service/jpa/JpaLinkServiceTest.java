...
public class JpaLinkServiceTest extends IntegrationTest {
    ...
    void shouldSaveLinkAndQuestion() throws URISyntaxException {
        QuestionEntity expected = new QuestionEntity();
        ...
        QuestionEntity actual = link.getQuestion();

        assertThat(actual.getAnswersCount()).isEqualTo(expected.getAnswersCount());
        assertThat(actual.getCommentsCount()).isEqualTo(expected.getCommentsCount());
    }
