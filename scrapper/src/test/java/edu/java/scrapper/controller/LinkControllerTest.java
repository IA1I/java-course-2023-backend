...
//
//    @Test
//    void shouldReturnListLinksResponseForGet() {
...
//
//    @Test
//    void shouldReturnLinkResponseForPost() throws URISyntaxException {
//        ResponseEntity<LinkResponse> expected = new ResponseEntity<>(
//            new LinkResponse(0L, "https://github.com/IA1I/java-course-2023-backend"),
//            HttpStatus.OK
//        );
//        AddLinkRequest addLinkRequest = new AddLinkRequest("https://github.com/IA1I/java-course-2023-backend");
//
...
//
//    @Test
//    void shouldThrowReAddLinkExceptionForPost() throws URISyntaxException {
//        AddLinkRequest addLinkRequest = new AddLinkRequest("https://github.com/IA1I/java-course-2023-backend");
//
...
//
//    @Test
//    void shouldThrowForDelete() throws URISyntaxException {
//        ResponseEntity<LinkResponse> expected = new ResponseEntity<>(
//            new LinkResponse(0L, "https://github.com/IA1I/java-course-2023-backend"),
//            HttpStatus.OK
//        );
