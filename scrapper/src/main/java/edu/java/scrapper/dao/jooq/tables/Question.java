...
public class Question extends TableImpl<QuestionRecord> {
     ...
     */
    public final TableField<QuestionRecord, Long> LINK_ID =
        createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>QUESTION.COMMENTS_COUNT</code>.
     */
    public final TableField<QuestionRecord, Integer> COMMENTS_COUNT =
        createField(DSL.name("COMMENTS_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>QUESTION.ANSWERS_COUNT</code>.
     */
    public final TableField<QuestionRecord, Integer> ANSWERS_COUNT =
        createField(DSL.name("ANSWERS_COUNT"), SQLDataType.INTEGER, this, "");
